...
export const INTRO_STEPS: IntroStep[] = [
  {
    id: 'welcome',
    headline: 'Welcome',
    body: 'This digital twin explores how solar farms generate electricity, and how thermal sensing and analytics can keep string inverters healthy for decades of operation. That work sits in a wider shift: by 2030, renewables and nuclear are together set to generate 50% of global electricity, up from 42% today.',
    stat: '42% today → 50% by 2030 · renewables + nuclear',
    scene: 'space',
  },
  {
    id: 'energy',
    headline: 'The Energy Challenge',
    body: 'Energy is becoming a critical bottleneck. Electricity demand is rising rapidly, driven by AI data centres, expanding digital services, and the electrification of transport and industry. Meeting United Nations 2030 sustainability targets will require a substantial expansion of reliable low-carbon generation. By 2030, renewables and nuclear are together set to generate 50% of global electricity, up from 42% today.',
    stat: '42% today → 50% by 2030 (renewables + nuclear)',
    scene: 'space-demand',
    counters: [
      {
        label: 'Share today (renewables + nuclear)',
        value: 42,
        suffix: '%',
        durationMs: 1600,
      ...
      {
        label: 'Share by 2030 (renewables + nuclear)',
        value: 50,
        suffix: '%',
        durationMs: 1800,
        reference: REF_PLACEHOLDER,
